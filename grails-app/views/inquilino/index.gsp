		...
		<div id="list-inquilino" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nome" title="${message(code: 'inquilino.nome.label', default: 'Nome')}" />
				...
				<g:each in="${inquilinoInstanceList}" status="i" var="inquilinoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${inquilinoInstance.id}">${fieldValue(bean: inquilinoInstance, field: "nome")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${inquilinoInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
